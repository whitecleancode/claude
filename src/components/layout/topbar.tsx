...
export function Topbar({ title }: TopbarProps) {
  ...
  return (
    <header className="relative sticky top-0 z-30 flex items-center justify-between h-16 px-4 lg:px-6 border-b border-white/10 bg-surface-primary/80 backdrop-blur-md" style={{ paddingTop: "var(--safe-top)" }}>
      {/* Neon gradient line */}
